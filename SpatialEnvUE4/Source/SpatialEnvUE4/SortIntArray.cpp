...
void USortIntArray::Integer_Sort(UPARAM(ref) TArray <int32>& Array_To_Sort, bool Descending, TArray <int32>& Sorted_Array)
{
...
void USortIntArray::Float_Sort(UPARAM(ref) TArray <float>& Array_To_Sort, bool Descending, TArray <float>& Sorted_Array)
{
    int32 m = Array_To_Sort.Num();      // Return the array size
    int32 a, k;
    bool bDidSwap;
...
void USortIntArray::String_Sort(UPARAM(ref) TArray <FString>& Array_To_Sort, bool Descending, TArray <FString>& Sorted_Array)
{
